...
RSpec.describe PostsController, type: :controller do
  ...
  # #13
    ...
    #POSTS will no longer need an index view because they will be displayed on the show view of the parent topic.
  ...
  describe "DELETE destroy" do
    it "deletes the post" do
      ...
      count = Post.where({id: my_post.id}).size  #why can't you just look for id? it should not be found and return nil, right?
